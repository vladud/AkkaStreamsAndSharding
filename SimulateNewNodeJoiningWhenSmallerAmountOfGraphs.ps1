...
Start-Process -FilePath $pathToExe -ArgumentList "5005 true 20"
...
#Start node 1
Start-Process -FilePath $pathToExe -ArgumentList "5006 false 20"
Start-Sleep -Milliseconds 500
...
#Node 2 joines cluster (auto-down-unreachable-after = 5s)