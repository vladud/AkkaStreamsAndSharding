...
Start-Process -FilePath $pathToExe -ArgumentList "5005 true 200 off"
...
#Wait even longer for all actors to be created on node 1
Start-Sleep -Milliseconds 10000

#Start node 1
Start-Process -FilePath $pathToExe -ArgumentList "5006 false 200 off" #auto-down-unreachable-after = off will still cause node 2 to be unreachable
Start-Sleep -Milliseconds 500
...
#Node 2 joines cluster (auto-down-unreachable-after = 6000s)